...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [Sample->steeltoe]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.transformations[0].sources[0].delegate.transformations[3] (RewritePath)
┃ ┃ ┃ ┃ ┃ ┃ Debug Path 'Sample.csproj' matched 'Sample(.*)' with groups {g0=Sample.csproj, g1=.csproj} and was rewritten to 'steeltoe.csproj'
┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'Sample.sln' matched 'Sample(.*)' with groups {g0=Sample.sln, g1=.sln} and was rewritten to 'steeltoe.sln'
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [Sample->steeltoe, sample-app->weatherforecast-stee...(truncated)]
